...
export function STK_DATEPICKER_18N_FACTORY(locale) {
  return new STKDatepickerI18nDefault(locale);
}
 ...
 */
@Injectable({providedIn: 'root', useFactory: STK_DATEPICKER_18N_FACTORY, deps: [LOCALE_ID]})
export abstract class StkDatepickerI18n {
  /**
   ...
   * @since 2.0.0
   */
  abstract getDayAriaLabel(date: StkDateStruct): string;
   ...
   * @since 3.0.0
   */
  getDayNumerals(date: StkDateStruct): string { return `${date.day}`; }
...
export class STKDatepickerI18nDefault extends StkDatepickerI18n {
  ...
  getDayAriaLabel(date: StkDateStruct): string {
